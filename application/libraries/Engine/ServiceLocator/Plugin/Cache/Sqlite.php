...
class Engine_ServiceLocator_Plugin_Cache_Sqlite extends Engine_ServiceLocator_Plugin_Abstract
{
  protected $_formClass = 'Engine_ServiceLocator_Form_Cache_Sqlite';
  ...
  public function onSubmit(array $data = array())
  {
    ...
    try {
      $cache = new Zend_Cache_Backend_Sqlite($data);
      $this->_data = $data;
      return true;
    } catch( Exception $e ) {
