...
class Engine_ServiceLocator_Plugin_Image_Gd extends Engine_ServiceLocator_Plugin_Abstract
{
  ...
  public function onSubmit(array $data = array())
  {
    ...
    try {
      $image = new Engine_Image_Adapter_Gd();
      $this->_data = $data;
      return true;
    } catch( Exception $e ) {
