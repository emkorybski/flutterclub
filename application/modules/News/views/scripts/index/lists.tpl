...
<?php endif; ?>
  <div class='comments_options'>
    ...
    <?php if(  $this->viewer()->getIdentity() && isset($this->form) ): ?>
  ...
  <?php if( $this->viewer()->getIdentity() && isset($this->form) ) echo $this->form->setAttribs(array('id' => 'comment-form', 'style' => 'display:none;'))->render() ?>
<?php if( !$this->page ): ?>
</div>
    <?php endif; ?>