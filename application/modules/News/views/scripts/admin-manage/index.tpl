  ...
  <table class='news_admin_table'>
    <thead>
      <tr>
        ...
        <th width="15% " style="text-align: left;"><?php echo $this->translate("Feed") ?></th>
        <th width="50%" style="text-align: left;"><?php echo $this->translate("Title") ?></th>        
        <th width="15%" style="text-align: left;"><?php echo $this->translate("Posted Date") ?></th>
        <th width="5%" style="text-align: left;"><?php echo $this->translate("Featured") ?></th>
