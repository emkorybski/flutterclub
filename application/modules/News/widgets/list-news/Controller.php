<?php
class News_Widget_ListNewsController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
      ...
      if(isset($_SESSION['keysearch']))
	    ...
	    $this->view->paginator =Engine_Api::_()->news()->getContentsPaginator(array(
          'category_id' => $category, 'search'=>$news_search_query, 'order' => 'pubDate DESC','limit'=>$limit,'is_active'=>1,'getcommment'=>true,
