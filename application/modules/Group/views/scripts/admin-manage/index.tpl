...
if( $settings->getSetting('user.support.links', 0) == 1 ) {
	echo 'More info: <a href="http://www.socialengine.net/support/documentation/article?q=191&question=Admin-Panel---Plugins--Groups" target="_blank">See KB article</a>.';	
} 
?>	
<br />
        ...
        <tr>
          ...
          <td>
            ...
            <?php echo $this->htmlLink(
                array('route' => 'default', 'module' => 'group', 'controller' => 'admin-manage', 'action' => 'delete', 'id' => $item->group_id),
