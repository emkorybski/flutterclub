 ...
 * @version    $Id: Performance.php 9673 2012-04-11 22:49:36Z richard $
 * @author     John
 */
...
class Core_Form_Admin_Settings_Performance extends Engine_Form
{
  public function init()
  {
    ...
    $description = vsprintf($description.$moreinfo, array(
      'http://www.socialengine.net/support/documentation/article?q=182&question=Adm in-Panel---Settings--Performance--Caching',
    ));
