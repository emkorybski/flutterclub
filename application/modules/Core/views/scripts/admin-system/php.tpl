 ...
 * @version    $Id: php.tpl 9673 2012-04-11 22:49:36Z richard $
 * @author     John
 */
?>
...
<?php
  ...
  if( $settings->getSetting('user.support.links', 0) == 1 ) {
    echo 'More info: <a href="http://www.socialengine.net/support/documentation/article?q=219&question=Admin-Panel---Stats--Server-Information" target="_blank">See KB article</a>.';	
  } 
?>	
