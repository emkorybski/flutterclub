...
if( $settings->getSetting('user.support.links', 0) == 1 ) {
	echo 'More info: <a href="http://www.socialengine.net/support/documentation/article?q=217&question=Admin-Panel---Layout--Menu-Editor" target="_blank">See KB article</a>.';	
} 
?>	
<br />
<br />
