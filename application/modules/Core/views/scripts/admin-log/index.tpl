...
<?php
  ...
  if( $settings->getSetting('user.support.links', 0) == 1 ) {
    echo 'More info: <a href="http://www.socialengine.net/support/documentation/article?q=216&question=Admin-Panel---Stats--Log-Browser" target="_blank">See KB article</a>.';	
  } 
?>	
