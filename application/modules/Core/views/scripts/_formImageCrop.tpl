 ...
 * @version    $Id: _formImageCrop.tpl 9683 2012-04-18 01:31:23Z pamela $
 * @author     John
 */
?>
...
<script type="text/javascript">
  ...
  var lassoCancel = function() {
    ...
    $('thumbnail-controller').innerHTML = <a href="javascript:void(0);" onclick="lassoStart();"><?php echo Zend_Json::encode($this->translate("Edit Thumbnail")) ?></a>;
    $('coordinates').value = "";
    lassoCrop.destroy();
  }
