...
<div class="he_friends_widget">
  <div class="inviter_widget_title"><?php echo $this->translate("INVITER_I connected with them on Twitter and Site"); ?></div>
  ...
  <?php else : ?>
    ...
    <script type="text/javascript">
      ...
      en4.core.runonce.add(function(){
        ...
        var $thumbs = $$('.inviter_twitter_connected .inviter_facebook_member');
        var $fb_members_tips = new HETips($thumbs, options);
      });
    </script>

    <div class="he_widget_container inviter_twitter_connected">
      <?php $counter = 0; ?>
  ...
  <div class="inviter_widget_title">
    <button onclick='InviterIntroduce.showConnectedFriends("twitter", <?php echo $this->jsonInline($this->translate('INVITER_Twitter Followers on Site')); ?>);'><?php echo $this->translate('See All'); ?></button>
  </div>
