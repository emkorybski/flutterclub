...
class Inviter_Widget_ListTopInvitersController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    $select = $userTb->select()
      ...
      ->joinInner(
        $invitesTb->info('name'),
        $userTb->info('name').'.user_id = '.$invitesTb->info('name').'.user_id', array('COUNT('.$invitesTb->info('name').'.invite_id) AS sent_invites'))
