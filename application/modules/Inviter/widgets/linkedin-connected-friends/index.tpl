...
<div class="he_friends_widget">
  <div class="inviter_widget_title"><?php echo $this->translate("INVITER_I connected with them on LinkedIn and Site"); ?></div>
  ...
  <?php else : ?>
    ...
    <script type="text/javascript">
      ...
      en4.core.runonce.add(function(){
        ...
        var $thumbs = $$('.inviter_linkedin_connected .inviter_facebook_member');
        var $fb_members_tips = new HETips($thumbs, options);
      });
    </script>

    <div class="he_widget_container inviter_linkedin_connected">
      <?php $counter = 0; ?>
    ...
    <div class="inviter_widget_title">
      <button onclick='InviterIntroduce.showConnectedFriends("linkedin", <?php echo $this->jsonInline($this->translate('INVITER_LinkedIn Connections on Site')); ?>);'><?php echo $this->translate('See All'); ?></button>
    </div>
