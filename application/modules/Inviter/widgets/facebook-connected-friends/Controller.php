...
class Inviter_Widget_FacebookConnectedFriendsController extends Engine_Content_Widget_Abstract
{
    ...
    public function indexAction()
    {
        ...
        if (!$this->getElement()->getTitle()) {
            $this->getElement()->setTitle('INVITER_Friended on Facebook and Site');
        }

        $this->view->members = $members = $providerApi->getAlreadyFriendContacts($token, $this->provider);
