...
class Inviter_Widget_LinkedinMembersController extends Engine_Content_Widget_Abstract
{
  ...
  public function indexAction()
  {
    ...
    $this->view->members = $members = $providerApi->getNoneFriendContacts($token, $this->provider, 9);
