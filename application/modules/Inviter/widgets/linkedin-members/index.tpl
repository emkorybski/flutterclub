...
<div class="he_friends_widget">
  <div class="inviter_widget_title"><?php echo $this->translate("INVITER_You're friended on LinkedIn, connect with them here!"); ?></div>
  ...
  <?php else : ?>
    ...
    <script type="text/javascript">
      ...
      en4.core.runonce.add(function(){
        ...
        var $thumbs = $$('.inviter_linkedin_members .inviter_facebook_member');
        var $fb_members_tips = new HETips($thumbs, options);
      });
    </script>

    <div class="he_widget_container inviter_linkedin_members">
      <?php $counter = 0; ?>
    ...
    <div class="inviter_widget_title">
      <button onclick="InviterIntroduce.showAddFriendsBox('linkedin');"><?php echo $this->translate('INVITER_VIEWS_SCRIPTS_INDEX_MEMBERS'); ?></button>
    </div>
