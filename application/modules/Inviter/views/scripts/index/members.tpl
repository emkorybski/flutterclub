...
<div class='global_form'>
  <div>
    <div>
      <h3><?php echo $this->translate('INVITER_VIEWS_SCRIPTS_INDEX_MEMBERS') ?></h3>
      <p class='form-description'><?php echo $this->translate('INVITER_VIEWS_SCRIPTS_INDEX_MEMBERS_DESCRIPTION')?></p>
