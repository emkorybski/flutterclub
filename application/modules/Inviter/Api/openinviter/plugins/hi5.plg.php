...
class hi5 extends openinviter_base
	...
	public function login($user,$pass)
		...
		$form_action="https://www.hi5.com/friend/login.do";
		$post_elements=array(
              'e13nLoginSource'=>'${e13nLoginSource}',
              'email'=>$user,
              'password'=>$pass,
              'remember'=>'on',
              'redirectPath'=>'',
	...
	public function sendMessage($session_id,$message,$contacts)
      ...
      $toIds = 'F:' . implode('###F:', $contact_ids);

      $url_send_message="http://hi5.com/friend/mail/displayComposeMail.do";
			...
			$post_elements=array('toIds'=>$toIds,
