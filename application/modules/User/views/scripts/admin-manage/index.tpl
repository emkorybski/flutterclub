...
<?php
	...
	if( $settings->getSetting('user.support.links', 0) == 1 ) {
		echo 'More info: <a href="http://www.socialengine.net/support/documentation/article?q=154&question=Admin-Panel---Manage--Members" target="_blank">See KB article</a>.';	
	} 
?>	
<br />
<br />
