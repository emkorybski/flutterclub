...
class Article_Widget_ListFeaturedController extends Engine_Content_Widget_Abstract
{
  ...
  public function indexAction()
  {
    ...
    $this->view->widget_name = 'article_featuredarticles_'.$this->getElement()->getIdentity();
