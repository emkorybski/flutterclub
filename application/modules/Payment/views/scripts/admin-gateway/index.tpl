...
if( $settings->getSetting('user.support.links', 0) == 1 ) {
	echo 'More info: <a href="http://www.socialengine.net/support/documentation/article?q=176&question=Admin-Panel---Billing--Gateways" target="_blank">See KB article</a>.';	
} 
?>
<br />
<br />
