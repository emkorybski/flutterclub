...
<?php
  ...
  if( $settings->getSetting('user.support.links', 0) == 1 ) {
    echo 'More info: <a href="http://www.socialengine.net/support/documentation/article?q=218&question=Admin-Panel---Layout--Language-Manager" target="_blank">See KB article</a>.';	
  } 
?>	
