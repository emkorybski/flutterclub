...
if( $settings->getSetting('user.support.links', 0) == 1 ) {
	echo 'More info: <a href="http://www.socialengine.net/support/documentation/article?q=174&question=Admin-Panel---Billing--Transactions" target="_blank">See KB article</a>.';	
} 
?>
